			...
			<div className="px-margin-mobile max-w-7xl mx-auto space-y-section-gap">
				<div className="grid lg:grid-cols-2 gap-stack-lg items-start">
					...
					<section className="bg-white rounded-3xl p-8 shadow-sm border border-outline-variant/20">
						<h2 className="font-serif text-2xl text-on-surface mb-stack-md">
							Send a Message
						</h2>
				...
				<section className="space-y-stack-md">
					<div className="flex justify-between items-end">
						...
						<button className="text-[10px] font-bold text-primary uppercase tracking-widest underline underline-offset-4 hover:opacity-70">
							View All
						</button>
					</div>
				...
				<section className="text-center py-stack-lg border-t border-outline-variant/30 flex flex-col items-center">
					<h3 className="text-[10px] font-bold text-on-surface-variant uppercase tracking-[0.3em] mb-8">
						Join the Community
					</h3>
